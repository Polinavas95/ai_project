...
from app.metrics import QUIZ_GIGA_AINVOKE
from app.prompts.quiz import system_prompt, user_prompt
...
class QuizAgent:
    ...
    async def ainvoke(
            self, history: list[str], action: str,
