...
class QuizAgent:
    ...
    def __init__(self, giga_client: GigaChat, token_verification: TokenVerification) -> None:
    ...
    async def ainvoke(
            self, history: list[str], action: str, study_topic: str,
            user_level: str, topic_context: str,
